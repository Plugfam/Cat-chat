    ...
    <div class="main">
      <div class="box" id="box">
        <div id="text">
          ...
          <p>
            <h3 class="centered-text">PLUGFAM PAIRING CODE</h3>
            <br>
            <h6>Made BY Plugfam🖕.</h6>
            <h6>Enter Your Number with Country Code.</h6>
            <div class="input-container">
              <input placeholder="233559278××××" type="number" id="number" placeholder="Mf Enter your Phone Pumber with Cuntry Code" name="">
